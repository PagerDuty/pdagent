#!/usr/bin/env python
#
# Python script to queue up a resolve for an incident in PagerDuty.
#
...
def main():
    ...
    queue_event("resolve", options.service_key, options.incident_key, options.description, details)
