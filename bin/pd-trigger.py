...
def main():
    ...
    description="Send a trigger event to PagerDuty."
    parser = build_send_arg_parser(description, False)
    args = parser.parse_args()
    details = parse_fields(args.fields)
    send_event("trigger", args.service_key, args.incident_key, args.description, details)
